...
const Checkout: React.FC = () => {
  ...
  const handlePayment = () => {
    ...
    const options = {
      key: 'rzp_test_n3YPzOoCrq26tE', // Your Razorpay test key
      amount: totalAmount * 100, // in paise
      currency: 'INR',
      name: 'Sri Sai Embroidery',
      description: 'Order Payment',
      handler: async function (response: any) {
        // On payment success, store orders
        ...
        try {
          for (const item of cartItems) {
            ...
            // 4. Build custom order id
            const customOrderId = `${year}${month}${day}-${categoryCode}-${sequenceStr}`;
            // Debug logs
  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center min-h-[90vh] bg-gradient-to-br from-purple-100 via-pink-50 to-white py-8 px-2">
        <Card className="w-full max-w-2xl shadow-2xl rounded-2xl border-0 bg-white p-0 overflow-hidden">
          <div className="p-8">
